(() => {
  ...
  var LockDetail = class extends import_components2.Module {
    ...
    async loadApiData_locksDetails() {
      const lockDetails = await getLocksDetails(this.getCampaignId());
      if (lockDetails) {
    ...
    renderFirstPanel() {
      ...
      this.imgToken.url = import_assets.default.fullPath((0, import_store2.getTokenIconPath)(this.locksDetails.tokenObj, (0, import_store2.getChainId)()));
    ...
    setDateLowerLimit() {
      ...
      const match = regex.exec((0, import_moment.default)(this.searchBox1.value).format("DD/MM/YYYY"));
    ...
    setDateUpperLimit() {
      const regex = /([0-9]+)\/([0-9]+)\/([0-9]+)/gm;
      const match = regex.exec((0, import_moment.default)(this.searchBox2.value).format("DD/MM/YYYY"));
      const dd = parseInt(match[1]);
      const mm = parseInt(match[2]);
      const yyyy = parseInt(match[3]);
      this.showEnd = [];
    ...
    onSearchBoxChanged() {
      ...
      if (this.searchBox.value != null) {
        ...
        for (let i = 0; i < this.copiedLockList.length; i++) {
          if (regex.test(this.copiedLockList[i].vestingId) == false && regex.test(this.copiedLockList[i].recipient) == false) {
    ...
    render() {
      return /* @__PURE__ */ this.$render("i-panel", {
        ...
        horizontalAlignment: "center",
        stack: { basis: "20%", shrink: "1", grow: "1" }
        ...
        width: "190",
        height: "47",
        onClick: () => this.onClickedAddLock(this.getCampaignId())
      })))), /* @__PURE__ */ this.$render("i-grid-layout", {
        templateColumns: ["auto"],
        templateRows: ["auto"],
        horizontalAlignment: "center",
        ...
        heading: true,
        background: { color: "#000000" },
        font: { name: "Montserrat", size: "12px" }
      })), /* @__PURE__ */ this.$render("i-grid-layout", {
        minHeight: "156px",
        maxWidth: "1400px",
        width: "calc(100% - 3rem)",
        ...
        margin: { left: "1.5rem", right: "1.5rem", top: "1rem", bottom: "1rem" },
        background: { color: "#000000" },
        border: { radius: "27px", width: "1px", color: "#000000", style: "solid" },
        gap: { row: 5, column: 5 },
        ...
        grid: { area: "record_label_area" },
        horizontalAlignment: "start",
        verticalAlignment: "center"
      }, /* @__PURE__ */ this.$render("i-label", {
        id: "TotalCampaignLabel",
        font: { name: "Montserrat", size: "16px" }
      })), /* @__PURE__ */ this.$render("i-hstack", {
        grid: { area: "record_value_area" },
        horizontalAlignment: "end",
        verticalAlignment: "center"
      }, /* @__PURE__ */ this.$render("i-label", {
        id: "TotalVestingRecords",
        font: { name: "Montserrat", size: "16px" }
      })), /* @__PURE__ */ this.$render("i-hstack", {
        ...
        id: "TotalRecipientsCaption",
        font: { name: "Montserrat", size: "16px" }
      })), /* @__PURE__ */ this.$render("i-hstack", {
        grid: { area: "lock_label_area" },
        horizontalAlignment: "start",
        verticalAlignment: "center"
      }, /* @__PURE__ */ this.$render("i-label", {
        id: "TotalLockedLabel",
        ...
        grid: { area: "lock_value_area" },
        horizontalAlignment: "end",
        verticalAlignment: "center"
      }, /* @__PURE__ */ this.$render("i-label", {
        id: "TotalLockedCaption",
        font: { name: "Montserrat", size: "16px" }
      })), /* @__PURE__ */ this.$render("i-hstack", {
        grid: { area: "claim_label_area" },
        horizontalAlignment: "start",
        verticalAlignment: "center"
      }, /* @__PURE__ */ this.$render("i-label", {
        id: "TotalClaimedLabel",
        font: { name: "Montserrat", size: "16px" }
      })), /* @__PURE__ */ this.$render("i-hstack", {
        grid: { area: "claim_value_area" },
        horizontalAlignment: "end",
        verticalAlignment: "center"
      }, /* @__PURE__ */ this.$render("i-label", {
        id: "TotalClaimedCaption",
        font: { name: "Montserrat", size: "16px" }
      })), /* @__PURE__ */ this.$render("i-vstack", {
        grid: { area: "btn_area" },
        horizontalAlignment: "center",
