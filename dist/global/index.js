define("@vesting/global",(require, exports)=>{
...
async function getERC20Amount(wallet, token, decimals) {
  let erc20 = new import_eth_wallet.Erc20(wallet, token, decimals);
...
var formatDate = (date, customType) => {
  const formatType = customType || "DD/MM/YYYY";
  return (0, import_moment.default)(date).format(formatType);
};
